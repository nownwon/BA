...
tweets_tech <- searchTwitter("Mercedes", n=500,lang = "en")
...
tweets_tech <- searchTwitter("Audi", n=500,lang = "en")
...
names(Sentimentscores_tech)<-"Mercedes"
names(Sentimentscores_tech1)<-"Audi"
...
ggplot(data=Sentimentscores_tech,aes(x=sentiment,y=Mercedes))+
  geom_bar(aes(fill=sentiment),stat = "identity")+
  theme(legend.position="none")+
  xlab("Sentiments")+ylab("Mercedes")+ggtitle("Mercedes Analysis")

ggplot(data=Sentimentscores_tech,aes(x=sentiment,y=Audi))+
  geom_bar(aes(fill=sentiment),stat = "identity")+
  theme(legend.position="none")+
  xlab("Sentiments")+ylab("Audi")+ggtitle("Audi Analysis")
